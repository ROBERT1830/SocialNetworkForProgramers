package com.robertconstantindinescu.my_social_network.presentation.edit_profile
...
class EditProfileScreenViewModel @Inject constructor(
    ...
    private val _instagramTextFieldState = mutableStateOf<StandardTextFieldState>(StandardTextFieldState())
